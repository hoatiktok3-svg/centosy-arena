...
const ICONS: Record<Tab, (a: boolean) => React.ReactElement> = {
  home: (a) => (
    <svg width="20" height="20" fill={a ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={a ? 0 : 1.8} viewBox="0 0 24 24">
...
const LABELS: Record<Tab, string> = {
  home: 'Home', games: 'Games', rank: 'Rank', honor: 'Honor', profile: 'Tôi',
}

const TABS: Tab[] = ['home', 'games', 'rank', 'honor', 'profile']
