...
## 3. Mục tiêu
Mock AI/admin generator tạo quiz/nhiệm vụ, lưu draft, không hardcode key.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 62.
...
- Build TypeScript OK.
- Các luồng chính của STEP 62 chạy đúng.
