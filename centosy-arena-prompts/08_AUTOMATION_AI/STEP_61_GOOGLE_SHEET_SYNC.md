...
## 3. Mục tiêu
Export CSV/chuẩn bị Google Sheet Sync, không hardcode API key.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 61.
...
- Build TypeScript OK.
- Các luồng chính của STEP 61 chạy đúng.
