...
## 3. Mục tiêu
Nâng cấp settings: general/points/modules/alerts/reward, tích hợp nhẹ.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 64.
...
- Build TypeScript OK.
- Các luồng chính của STEP 64 chạy đúng.
