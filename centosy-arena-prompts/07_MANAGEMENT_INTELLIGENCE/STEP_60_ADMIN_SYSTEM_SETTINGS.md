...
## 3. Mục tiêu
Cài đặt hệ thống nền móng: điểm, module, cảnh báo, default settings.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 60.
...
- Build TypeScript OK.
- Các luồng chính của STEP 60 chạy đúng.
