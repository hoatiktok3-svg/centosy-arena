# STEP 27 — Role Permission System
...
## 3. Mục tiêu
Phân quyền employee/manager/admin/director, tạo permission helper, chặn AdminPanel theo quyền.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 27.
...
- Build TypeScript OK.
- Các luồng chính của STEP 27 chạy đúng.
