...
## 3. Mục tiêu
Dashboard cá nhân: tên, role, khối, phòng ban, điểm, rank, quick actions.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 28.
...
- Build TypeScript OK.
- Các luồng chính của STEP 28 chạy đúng.
