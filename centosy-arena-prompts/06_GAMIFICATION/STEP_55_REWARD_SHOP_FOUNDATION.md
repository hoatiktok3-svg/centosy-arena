...
## 3. Mục tiêu
Shop đổi quà nền móng, item, request redemption, chưa trừ điểm tự động.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 55.
...
- Build TypeScript OK.
- Các luồng chính của STEP 55 chạy đúng.
