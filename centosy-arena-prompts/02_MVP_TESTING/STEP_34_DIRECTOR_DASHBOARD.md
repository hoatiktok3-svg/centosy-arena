...
## 3. Mục tiêu
Dashboard giám đốc toàn công ty, KPI, cảnh báo, top phòng ban.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 34.
...
- Build TypeScript OK.
- Các luồng chính của STEP 34 chạy đúng.
