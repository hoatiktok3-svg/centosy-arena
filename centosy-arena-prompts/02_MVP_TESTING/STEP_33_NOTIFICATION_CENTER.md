...
## 3. Mục tiêu
Trung tâm thông báo nội bộ, mark as read, filter theo phòng ban/user.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 33.
...
- Build TypeScript OK.
- Các luồng chính của STEP 33 chạy đúng.
