# STEP 36 — Safe Vercel Internal Test
...
## 3. Mục tiêu
Chuẩn bị public test nội bộ trên Vercel, env/security/build checklist.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 36.
...
- Build TypeScript OK.
- Các luồng chính của STEP 36 chạy đúng.
