# STEP 37 — Employee Feedback Form
...
## 3. Mục tiêu
Form báo lỗi/góp ý, severity, screen, admin xem feedback.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 37.
...
- Build TypeScript OK.
- Các luồng chính của STEP 37 chạy đúng.
