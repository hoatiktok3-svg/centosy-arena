...
## 3. Mục tiêu
Hồ sơ nhân viên nâng cao: thông tin, phòng ban, điểm, huy hiệu, nhiệm vụ gần đây.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 40.
...
- Build TypeScript OK.
- Các luồng chính của STEP 40 chạy đúng.
