...
## 3. Mục tiêu
Danh bạ nội bộ, search/filter theo tên/khối/phòng ban, chỉ user approved.
...
- Không deploy/push.
- Không cài package mới nếu chưa hỏi.
- Không làm tính năng nâng cao ngoài phạm vi STEP 41.
...
- Build TypeScript OK.
- Các luồng chính của STEP 41 chạy đúng.
